    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final pokeminData = snapshot.data!;
          final String gifUrl = pokeminData['sprites']['versions']
                      ['generation-v']['black-white']['animated']
                  ['front_default'] ??
              pokeminData['sprites']['front_default'];
          return Container(
            color: typeColor,
            child: Center(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Altura: ${(pokeminData['height'] / 10).toStringAsFixed(1)} m',
                        style:
                    ...
                    Wrap(
                      spacing: 10,
                      children: (pokeminData['types'] as List)
                          .map((type) => Chip(
                    ...
                    Wrap(
                      spacing: 10,
                      children: (pokeminData['abilities'] as List)
                          .map((ability) => Chip(
                              label: Text(
